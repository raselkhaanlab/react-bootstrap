    ...
    >
      <div className="container-fluid d-flex justify-content-between align-items-center px-5">
        <Nav className="d-flex align-items-center">
          <MenuToogleIcon height={24} width={24} onClick={() => onToggle()} role="button" className="d-block d-lg-none" />
        </Nav>
        <OverlayTrigger
          trigger="click"
          placement="bottom"
          overlay={<UserPopover className="" onClose={userPopover.handleClose}/>}
          rootClose
        >
